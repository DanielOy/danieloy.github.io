...
export class HomeService {
    ...
    private qualificationsES: Qualification[] = [
        { title: "Diciplina 💪", description: "Cuando me decido a lograr algo uso el 100% de mi hasta alcanzarlo, no rendirse ante las dificultades y ser constante ha sido clave en mi carrera." },
    ...
    private skillsEN: Skill[] = [
        { name: '.NET', description: 'I have developed desktop applications with .NET for the last 3 years, as well as some web applications, web scrappers, windows services, also I created and consumed some own and third parties APIs.', image: '../../assets/images/net-logo.png', experience: 'Strong', experiencePorcentage: 75 },
        { name: 'Microsoft Sql Server', description: 'I frequently use SQL Server in my projects, where I apply data definition and manipulation languages to create and manage tables, procedures, triggers, indexes and other elements.', image: '../../assets/images/msserver-logo.png', experience: 'Strong', experiencePorcentage: 75 },
        { name: 'Git', description: 'I use GIT since years ago to control the changes of the projects where I work, I have used from basic commands to upload and download changes to more complex commands to rewrite the change log and manage branches.', image: '../../assets/images/git-logo.png', experience: 'Strong', experiencePorcentage: 75 },
        { name: 'Angular', description: "I've been using angular for a couple of years and currently in my personal projects to improve my knowledge and adopt best practices for its use and application.", image: '../../assets/images/angular-logo.png', experience: 'Intermediate', experiencePorcentage: 75 },
        { name: 'Ionic Framework', description: "Professionally I've a couple of years of experience using ionic 4 in the creation of a hybrid application that is currently available for android and ios.  Nowadays I continue giving maintenance to this application, in addition to continue practicing this framework in my free time.", image: '../../assets/images/ionic-logo.png', experience: 'Intermediate', experiencePorcentage: 50 },
        { name: 'Bootstrap 4', description: "I've been using this Framework for a couple of years. I know the main points besides I'm improving by using it in my web projects.", image: '../../assets/images/bootstrap-logo.png', experience: 'Basic', experiencePorcentage: 50 },
        { name: 'Docker', description: "I use Docker for my personal projects in order to simplify and speed up certain processes. Making use of commands for the creation and use of containers, volumes, port management that I continue to practice in every personal project I start.", image: '../../assets/images/docker-logo.png', experience: 'Basic', experiencePorcentage: 40 }
    ];

    private skillsES: Skill[] = [
        { name: '.NET', description: 'He desarrollado aplicaciones de escritorio con .NET los últimos 3 años, además de algunas aplicaciones web, web scrappers, servicios de windows, así también creado y consumido algunas APIs propias y terceros.', image: '../../assets/images/net-logo.png', experience: 'Alto', experiencePorcentage: 80 },
        { name: 'Microsoft Sql Server', description: 'Uso frecuentemente SQL Server en mis proyectos, en donde aplico lenguajes de definición y manipulación de datos para crear y gestionar tablas, procedimientos, disparadores, índices, entre otros elementos.', image: '../../assets/images/msserver-logo.png', experience: 'Alto', experiencePorcentage: 80 },
        { name: 'Git', description: 'Uso GIT desde años atrás para controlar los cambios de los proyectos donde trabajo, he usado desde los comandos básicos para subir y descargar cambios hasta más complejos para reescribir la bitácora de cambios y administrar ramas.', image: '../../assets/images/git-logo.png', experience: 'Alto', experiencePorcentage: 80 },
        { name: 'Angular', description: "He usado angular desde hace un par de años y actualmente en mis proyectos personales para mejorar mi conocimiento y adoptar las mejores prácticas para su uso y aplicación.", image: '../../assets/images/angular-logo.png', experience: 'Intermedio', experiencePorcentage: 70 },
        { name: 'Ionic Framework', description: 'Profesionalmente tengo un par de años experiencia usando ionic 4 en la creación de una aplicación hibrida que actualmente está disponible para android y ios.  Actualmente continúo dándole mantenimiento a dicha aplicación, además de continuar practicando este framework en mis tiempos libres.', image: '../../assets/images/ionic-logo.png', experience: 'Intermedio', experiencePorcentage: 60 },
        { name: 'Bootstrap 4', description: "He usado este Framework un par de años. Conozco los principales puntos para su uso lo cual voy mejorando al hacer uso de este en mis proyectos web.", image: '../../assets/images/bootstrap-logo.png', experience: 'Basico', experiencePorcentage: 50 },
        { name: 'Docker', description: "Ocupo Docker para mis proyectos personales con el fin de simplificar y acelerar ciertos procesos. Haciendo uso de comandos para la creación y uso de contenedores, volúmenes, gestión de puertos que continúo practicando en cada proyecto que inicio.", image: '../../assets/images/docker-logo.png', experience: 'Basico', experiencePorcentage: 40 }
    ];
